 ...
 * @param <T>
 */
@Plugin(type = CreatePsfCommand.class, menuPath = "Plugins>Deconvolution>Cosmos PSF")
public class CreatePsfCommandCosmos <T extends RealType<T> & NativeType<T>> extends CreatePsfCommand
{
