...
{
	RichardsonLucyFilter<T,FloatType> rl;
	RichardsonLucyFilter<T,FloatType> rlCandidate;
	...
	public boolean process()
	{
		...
		for (int i=1;i<iterations;i++)
		{
			...
			// calculate stats of estimagte produced with candidate ri
	...
	/*		System.out.println("sums are: "+stats1.getArraySumEstimate()[i-1]+" "+stats2.getArraySumEstimate()[i-1]);
		...
		*/
			...
			else if (fuzzyTwo>fuzzyThreshold)
			{
				...
				RichardsonLucyFilter<T,FloatType> temp = rl;
				rl=rlCandidate;
				rlCandidate=temp;
	...
	public RichardsonLucyFilter<T,FloatType> getRL()
	{
		return rl;
	}
	
	public RichardsonLucyFilter<T,FloatType> getRLCandidate()
	{
		return rlCandidate;
	}
