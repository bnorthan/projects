...
SWIGEXPORT jlong JNICALL Java_com_truenorth_wrappers_YacuDecu_1swigJNI_new_1float_1array(JNIEnv *jenv, jclass jcls, jint jarg1) {
  jlong jresult = 0 ;
  int arg1 ;
  float *result = 0 ;
...
SWIGEXPORT void JNICALL Java_com_truenorth_wrappers_YacuDecu_1swigJNI_delete_1float_1array(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  float *arg1 = (float *) 0 ;
...
SWIGEXPORT jfloat JNICALL Java_com_truenorth_wrappers_YacuDecu_1swigJNI_float_1array_1getitem(JNIEnv *jenv, jclass jcls, jlong jarg1, jint jarg2) {
  jfloat jresult = 0 ;
  float *arg1 = (float *) 0 ;
  int arg2 ;
  float result;
...
SWIGEXPORT void JNICALL Java_com_truenorth_wrappers_YacuDecu_1swigJNI_float_1array_1setitem(JNIEnv *jenv, jclass jcls, jlong jarg1, jint jarg2, jfloat jarg3) {
  float *arg1 = (float *) 0 ;
  int arg2 ;
  float arg3 ;
...
SWIGEXPORT jint JNICALL Java_com_truenorth_wrappers_YacuDecu_1swigJNI_deconv_1device(JNIEnv *jenv, jclass jcls, jlong jarg1, jlong jarg2, jlong jarg3, jlong jarg4, jfloatArray jarg5, jfloatArray jarg6, jfloatArray jarg7) {
  jint jresult = 0 ;
  unsigned int arg1 ;
  size_t arg2 ;
  size_t arg3 ;
